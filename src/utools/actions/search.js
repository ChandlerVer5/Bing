import { UPDATE_TERM, MOVE_CURSOR, SELECT_ELEMENT, SHOW_RESULT, HIDE_RESULT, UPDATE_RESULT, RESET, CHANGE_VISIBLE_RESULTS } from '@/constants/actionTypes'
import getPlugins from '@/plugins'
import { getPlugSettings } from '@/plugins/config'
 ...
 * @return {Object}  redux action
 */
export function updateItem(term) {
  if (term === '') {
    return reset()
  }
  return (dispatch) => {
